...
export const TECHNICAL_LABS: readonly LabDescriptor[] = [
  ...
  {
    id: 'performance',
    titleKey: 'pages.labs.performance.title',
    descriptionKey: 'pages.labs.performance.description',
    plannedPhase: null,
  },
  {
    id: 'browser-storage',
  ...
  {
    id: 'browser-apis',
    titleKey: 'pages.labs.browserApis.title',
    descriptionKey: 'pages.labs.browserApis.description',
    plannedPhase: null,
  },
  {
    id: 'workers',
    titleKey: 'pages.labs.workers.title',
    descriptionKey: 'pages.labs.workers.description',
    plannedPhase: null,
  },
  {
    id: 'offline',
  ...
  {
    id: 'leader-election',
    titleKey: 'pages.labs.leaderElection.title',
